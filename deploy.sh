...
# 6. Package browser extension (Chrome cannot load venv/__pycache__)
print_info "Packaging browser extension..."
./build_extension.sh
print_status "Extension packaged in extension/"

# 7. Browser Extension Instructions
echo
...
echo "4. Select the extension/ subfolder (NOT the project root):"
echo "   $(pwd)/extension"
echo
echo "🔥 Firefox:"
...
echo "4. Select manifest.json from: $(pwd)/extension"
echo
